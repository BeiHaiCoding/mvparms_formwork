...
/**
 * Created by Administrator on 2017/4/10. SP数据保存相关帮助类
 */
public class SPHelper {
     ...
     * @param context
     * @param key
     * @param defaultObject 如果存的是字符串类型，参数可能传 ""，亦能传null，都代表String表为类型
     * @return
     */
     ...
     *                modified:
     */
    public static void savObj(Context context, String key, Object obj) {
        try {
            // 保存对象
            ...
            e.printStackTrace();
            MLogHelper.i("SPHelper", "保存obj失败" + e.getMessage());
        }
    }
    ...
    public static Object readObj(Context context, String key) {
        try {
            ...
            MLogHelper.i("SPHelper", "获取obj失败" + e.getMessage());
        } catch (IOException e) {
            MLogHelper.i("SPHelper ", "获取obj失败" + e.getMessage());
